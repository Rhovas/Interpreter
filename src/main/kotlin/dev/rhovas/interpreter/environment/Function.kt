...
sealed class Function(
    ...
    open val generics: List<Type.Generic>,
    ...
    ) : Function(name, generics, parameters, returns, throws) {
    ...
    data class Method(
        ...
        ) : Function(function.name, function.generics, function.parameters.subList(1, function.parameters.size), function.returns, function.throws) {
