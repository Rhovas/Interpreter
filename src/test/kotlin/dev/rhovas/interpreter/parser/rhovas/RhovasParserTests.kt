            ...
            fun testFunction(): Stream<Arguments> {
                return Stream.of(
                    Arguments.of("Func", "func name() { body; }",
                        RhovasAst.Statement.Function("name", listOf(), null, listOf(), RhovasAst.Statement.Block(listOf(statement("body")))),
                    ),
                    Arguments.of("Empty Body", "func name() {}",
                        RhovasAst.Statement.Function("name", listOf(), null, listOf(), block()),
                    ),
                    Arguments.of("Single Parameter", "func name(parameter) {}",
                        RhovasAst.Statement.Function("name", listOf("parameter" to null), null, listOf(), block()),
                    ),
                    Arguments.of("Multiple Parameters", "func name(first, second, third) {}",
                        RhovasAst.Statement.Function("name", listOf("first" to null, "second" to null, "third" to null), null, listOf(), block()),
                    ),
                    Arguments.of("Typed Parameter", "func name(parameter: Type) {}",
                        RhovasAst.Statement.Function("name", listOf("parameter" to RhovasAst.Type("Type", null)), null, listOf(), block()),
                    ),
                    Arguments.of("Trailing Comma", "func name(parameter,) {}",
                        RhovasAst.Statement.Function("name", listOf("parameter" to null), null, listOf(), block()),
                    ),
                    Arguments.of("Return Type", "func name(): Type {}",
                        RhovasAst.Statement.Function("name", listOf(), RhovasAst.Type("Type", null), listOf(), block()),
                    ),
                    Arguments.of("Single Throws", "func name() throws Type {}",
                        RhovasAst.Statement.Function("name", listOf(), null, listOf(RhovasAst.Type("Type", null)), block()),
                    ),
                    Arguments.of("Multiple Throws", "func name() throws First, Second, Third {}",
                        RhovasAst.Statement.Function("name", listOf(), null, listOf(RhovasAst.Type("First", null), RhovasAst.Type("Second", null), RhovasAst.Type("Third", null)), block()),
                    ),
